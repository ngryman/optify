...
(function(factory) {
	 ...
	 * Optify!
	 *
	 * @param {object} options Set of options (or named arguments) to build the combination matrix.
	 * @param {function|object|*} [undefValue] Explicit value of the *undefined value*.
	 * @param {function} [fn] Function invoked for each matrix row.
	 * @param {function} [done] Callback invoked when all async `fn` have finished.
